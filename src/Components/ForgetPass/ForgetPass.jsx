...
export default function ForgetPass() {
    ...
    let {userPass , setuserPass} = useContext(UserContext);
...
const [isLoading, setisLoading] = useState(false);
  ...
  {ApiError}
    ...
    <h1 className='text-center font-bold text-2xl py-7'>Forget Your Password <i className="fa-regular fa-face-grimace"></i></h1>
